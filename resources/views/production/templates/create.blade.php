@extends('layouts.app', ['title' => 'Create Production Template'])

@section('content')
<div class="max-w-6xl mx-auto">
    <form action="{{ route('production.templates.store') }}" method="POST" id="templateForm" class="space-y-8">
        @csrf
                ...
                <div class="glass-card p-8 rounded-[2.5rem] border border-white/5 relative overflow-hidden">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="code" value="{{ old('code') }}" required placeholder="Misal: TPL-PROD-01" class="w-full bg-slate-900/50 border-white/5 rounded-2xl px-5 py-4 text-sm text-indigo-400 font-bold focus:ring-2 focus:ring-indigo-500/20 outline-none transition-all">
                        </div>
                        <div class="space-y-2">
                            <label class="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Nama Template</label>
                            <input type="text" name="name" value="{{ old('name') }}" required placeholder="Misal: Template Kursi Kayu" class="w-full bg-slate-900/50 border-white/5 rounded-2xl px-5 py-4 text-sm text-white focus:ring-2 focus:ring-indigo-500/20 outline-none transition-all">
                        </div>
                        <div class="space-y-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="marketing" value="{{ old('marketing') }}" placeholder="Nama Marketing (Opsional)..." class="w-full bg-slate-900/50 border-white/5 rounded-2xl px-5 py-4 text-sm text-white focus:ring-2 focus:ring-indigo-500/20 outline-none transition-all">
                        </div>
                        <div class="space-y-2">
                            <label class="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Estimasi Durasi (Hari)</label>
                            <input type="number" name="duration" value="{{ old('duration') }}" placeholder="Contoh: 2" class="w-full bg-slate-900/50 border-white/5 rounded-2xl px-5 py-4 text-sm text-white focus:ring-2 focus:ring-indigo-500/20 outline-none transition-all">
                        </div>
                    </div>
                </div>
                ...
                <div class="glass-card p-8 rounded-[2.5rem] border border-white/5 relative overflow-hidden sticky top-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="notes" rows="6" class="w-full bg-slate-900 border-white/5 rounded-2xl px-5 py-4 text-sm text-white focus:ring-2 focus:ring-indigo-500/20 outline-none transition-all resize-none" placeholder="Tambahkan instruksi resep standar..."></textarea>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function addStageRow(data = null) {
        ...
        if (data) {
            ...
            addItemRow(stageBlock); // Default one item row
        }
